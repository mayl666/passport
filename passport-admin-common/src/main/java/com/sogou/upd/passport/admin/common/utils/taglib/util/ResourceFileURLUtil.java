...
public final class ResourceFileURLUtil {
     ...
     * 默认的JPG格式图片域名
     */
    private static final String JPG_DEFAULT_DOMAIN = "";
    /**
     * 默认的JS域名
     */
    private static final String JS_DEFAULT_DOMAIN = "";
    /**
     * 默认的CSS域名
     */
    private static final String CSS_DEFAULT_DOMAIN = "";
    /**
     * css的正则表达式模式
     */
     ...
     */
    @Inject
    public static void injectResCfgMap(IStaticResCfgService staticResCfgService) {
     ...
     * @return
     */
    private static String getHashFilePath(Map resMap, String path) {
